...
class UsuarioDAO {
    ...
    public function listarUsuarios() {
        ...
        //me conecto a la db
        $conn = new mysqli($yourHostname, $yourUsername, $yourPassword, $yourDatabase);     
    ...
    public function addUsuario($user,$pass) {
        try {
            $conexion = new mysqli($yourHostname, $yourUsername, $yourPassword, $yourDatabase);    
