...
<body class="body-table">
    ...
    <div class="container mt-5">
        <div>
            <h3 class="text-center text-light letter-spacing titulo">Listado de Usuarios</h3>
        </div>
        <button type="button" class="btn-agregar mb-2" data-bs-toggle="modal" data-bs-target="#addModal">
            Agregar Usuario
        </button>
            ...
            <table class="table table-dark border-0">
                ...
                <tbody>
                    ...
                    foreach ($listUsuObj as $usuObj) {
                        ...
                        echo "<td>";
                        echo "<a href='editUser.php?id=$idUser&mensaje='><i class='bi bi-pencil-fill m-1 color-btn'></i></a>";
                        echo "<a href='#' data-bs-toggle='modal' data-bs-target='#delModal' idUsuario='$idUser' user='$user' ><i class='bi bi-trash3-fill m-1 color-btn'></i></a>";
                        echo "</td>";
            ...
            <div class="modal-content">
                ...
                <div class="d-flex flex-column justify-content-center align-items-center mt-2">
                    <form action="../controller/addUser.php" method="post">
                        <input type="email" name="user" id="user" onkeyup="validarUsu()" class="form-control mb-3"
                            required placeholder="usuario">
                        <input type="password" name="pass" id="pass" onkeyup="defFortaleza()" class="form-control mb-3"
                            required placeholder="contraseña">
                        <input type="password" name="repPass" id="repPass" onkeyup="compararPass()"
                            class="form-control mb-3" required placeholder="reingrese la contraseña">
